...
//const minerAddress = '';
const minerAddress = '0x0E875b2c1f859FD8B047243a26729f0cA5904e15';
//https://bscscan.com/address/0x0E875b2c1f859FD8B047243a26729f0cA5904e15#code
var started = true;
var canSell = true;
...
function refreshData() {
    ...
    contract.methods.EGGS_TO_HIRE_1MINERS().call().then(eggs => {
        eggstohatch1 = eggs
        var dailyPercent = Number((115200 / eggstohatch1) * 100);
        var apr = dailyPercent * 365;
        $("#daily-rate").html(`Up to ${dailyPercent}% Daily ~ ${apr}% APR`);
    }).catch((err) => {
    ...
    contract.methods.getEggsYield(web3.utils.toWei('1')).call().then(result => {
        ...
        $("#example-bnb").html(roundNum(amt+.02))
